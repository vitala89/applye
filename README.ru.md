...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.29.3-4F5BFF?style=flat" alt="Версия 0.29.3">
...
Сборки для Windows, Linux и macOS на Intel собирает релизный workflow, они появятся здесь со
следующей версией по тегу. До этого - [сборка из исходников](#быстрый-старт), три команды, работает
на всех трёх платформах.
