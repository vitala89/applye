/**
 * The location vocabulary the Discover feed classifies against: every country,
 * its names and ISO2 code, the cities worth resolving by name, and the US
 * states and Canadian provinces.
 *
 * Split out of `discover-location.ts`, which held the tables and the matching
 * rules together at 910 lines against a 400 budget. The two change on different
 * occasions - this file grows when a board starts naming a place a new way, the
 * rules change when a match turns out to be ambiguous - and the rules are the
 * half worth reading.
 *
 * The trade this file makes, everywhere: a wrong bucket is visible in the
 * Locations popover and can be ignored, a job classified as Other is not. Where
 ...
 */
export const US_STATES: RegionCode[] = [
 ...
 */
export const CA_PROVINCES: RegionCode[] = [
