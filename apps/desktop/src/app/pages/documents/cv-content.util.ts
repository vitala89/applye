...
// Style editing and entry editing live in their own files - this module was
// 1245 lines against a 400 budget and held four unrelated jobs. They are
// re-exported here rather than imported directly by every consumer, because
// splitting a module costs each consumer one import line and three of them are
// already over budget: the size gate refused that version, which is the whole
// reason those files are separate now. Import from the specific module in new
// code.
