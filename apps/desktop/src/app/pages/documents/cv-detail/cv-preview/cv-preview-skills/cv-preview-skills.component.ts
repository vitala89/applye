...
/**
 * The CV preview's skills atom: the section title and one row per skill
 * group, each label and value list selectable and inline-editable.
 *
 ...
 */
@Component({
  selector: 'app-cv-preview-skills',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgStyle],
  templateUrl: './cv-preview-skills.component.html',
  styleUrl: './cv-preview-skills.component.scss',
})
export class CvPreviewSkillsComponent {
