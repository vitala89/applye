 ...
 * job each one belongs to, and the in-flight state of an export or a delete.
 *
 ...
 * shape `ProfilePhotoStore` settled.
 */
@Injectable()
export class CoverLetterListStore {
  ...
  /**
   * The company and role a document is attached to, as facts rather than a
   * sentence: an application points at the document, and the job at the
   * application. The page joins them, because a separator is presentation.
   */
