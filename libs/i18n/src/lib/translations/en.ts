...
export const en: TranslationMap = {
  ...
  jobs: {
    ...
    identity_badge_busy: 'Identifying a job',
    identity_badge_busy_hint: 'Naming the company and role in the background.',
    identity_badge_ask: 'Name this job',
    identity_badge_ask_hint: 'The posting did not say. Open it to fill it in.',
    parsing: 'Parsing…',
    ...
    gap: {
      ...
      analyzing_cover_letter: 'Checking your profile against this job...',
      question_of: 'Question',
      answer_placeholder: 'Type your answer, or Skip',
      skip: 'Skip',
      next: 'Next',
      review_title: 'Add these to your CV?',
      review_title_cover_letter: 'Add these to your cover letter?',
    ...
    wizard: {
      ...
      tailor_cancel_hint: 'Finishes the pass in progress, then stops before the next one.',
      tailor_cancelling: 'Finishing this pass…',
