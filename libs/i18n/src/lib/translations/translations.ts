...
const en: TranslationMap = {
  ...
  myjobs: {
    ...
    paste_title: 'Paste a job',
    paste_hint: 'Paste the full job description. It is parsed locally (0 tokens).',
    paste_submit: 'Add job',
...
const de: TranslationMap = {
  ...
  myjobs: {
    ...
    paste_title: 'Stelle einfügen',
    paste_hint: 'Füge die vollständige Stellenbeschreibung ein. Lokale Verarbeitung (0 Tokens).',
    paste_submit: 'Stelle hinzufügen',
