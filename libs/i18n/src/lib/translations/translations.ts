...
const en: TranslationMap = {
  ...
  settings: {
    ...
    geo_scope_hint:
      'Discover scans keep only openings inside this scope. Worldwide keeps everything.',
...
const de: TranslationMap = {
  ...
  settings: {
    ...
    geo_scope_hint:
      'Discover-Scans behalten nur Stellen innerhalb dieses Bereichs. Weltweit behält alles.',
