...
const en: TranslationMap = {
  ...
  jobs: {
    ...
    change_status_confirm_title: 'Change status?',
    change_status_confirm: 'Revert this application back to Saved?',
    change_status_confirm_btn: 'Yes, change it',
...
const de: TranslationMap = {
  ...
  jobs: {
    ...
    change_status_confirm_title: 'Status ändern?',
    change_status_confirm: 'Diese Bewerbung zurück auf „Gespeichert“ setzen?',
    change_status_confirm_btn: 'Ja, ändern',
