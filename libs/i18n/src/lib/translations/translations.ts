...
const en: TranslationMap = {
  ...
  jobs: {
    ...
    wizard: {
      ...
      review_eyebrow: 'Step 1 · Review',
      review_title: 'Read the scoring before you tailor',
      review_subtitle:
        'A quick recap of the fit analysis. Nothing here is submitted — you always decide whether to apply.',
      top_flags_title: 'Top red flags',
      top_notes_title: 'Before you submit',
      portal_eyebrow: 'Step 2 · Portal answers',
      portal_title: 'Draft your application questions',
      redraft_all: 'Re-draft all answers',
      tailor_eyebrow: 'Step 3 · Tailor CV',
      ...
      apply_title: 'Copy each field into the portal',
      apply_subtitle:
...
const de: TranslationMap = {
  ...
  jobs: {
    ...
    wizard: {
      ...
      review_eyebrow: 'Schritt 1 · Prüfen',
      review_title: 'Bewertung lesen, bevor du anpasst',
      review_subtitle:
        'Ein kurzer Überblick der Passungsanalyse. Hier wird nichts abgeschickt — du entscheidest immer, ob du dich bewirbst.',
      top_flags_title: 'Wichtigste Warnsignale',
      top_notes_title: 'Vor dem Absenden',
      portal_eyebrow: 'Schritt 2 · Portalantworten',
      portal_title: 'Bewerbungsfragen entwerfen',
      redraft_all: 'Alle Antworten neu entwerfen',
      tailor_eyebrow: 'Schritt 3 · Lebenslauf anpassen',
      ...
      apply_title: 'Jedes Feld ins Portal kopieren',
      apply_subtitle:
